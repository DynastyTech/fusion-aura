  ...
  return (
    <main className="min-h-screen overflow-hidden">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-primary-light/30 rounded-full blur-3xl animate-float" />
        <div className="absolute bottom-0 right-1/4 w-80 h-80 bg-primary-dark/20 rounded-full blur-3xl animate-float" style={{ animationDelay: '1.5s' }} />
