...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('STRIPE_CHECKOUT', 'BANK_TRANSFER');
...
CREATE TABLE "orders" (
    ...
    "shippingCountry" TEXT NOT NULL DEFAULT 'ZA',
    "shippingPhone" TEXT,
...
CREATE TABLE "payments" (
    ...
    "method" "PaymentMethod" NOT NULL DEFAULT 'STRIPE_CHECKOUT',
    "stripePaymentIntentId" TEXT,
    "stripeChargeId" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
